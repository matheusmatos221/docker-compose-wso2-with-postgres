...
-- SQLINES LICENSE FOR EVALUATION USE ONLY
CREATE SEQUENCE IDN_OAUTH_CONSUMER_APPS_seq;

CREATE TABLE IF NOT EXISTS IDN_OAUTH_CONSUMER_APPS (
            ID INTEGER NOT NULL DEFAULT NEXTVAL ('IDN_OAUTH_CONSUMER_APPS_seq'),
...
CREATE TABLE IF NOT EXISTS IDN_OAUTH2_ACCESS_TOKEN (
            ...
            REFRESH_TOKEN_TIME_CREATED TIMESTAMP(0) NOT NULL DEFAULT CURRENT_TIMESTAMP,
...
CREATE TABLE IF NOT EXISTS IDN_OAUTH2_ACCESS_TOKEN_AUDIT (
            ...
            USER_TYPE VARCHAR (25),
            GRANT_TYPE VARCHAR (50),
            TIME_CREATED TIMESTAMP(0) NULL,
            REFRESH_TOKEN_TIME_CREATED TIMESTAMP(0) NULL,
            VALIDITY_PERIOD BIGINT,
            REFRESH_TOKEN_VALIDITY_PERIOD BIGINT,
            TOKEN_SCOPE_HASH VARCHAR(32),
            ...
            ACCESS_TOKEN_HASH VARCHAR(512),
            REFRESH_TOKEN_HASH VARCHAR(512),
            INVALIDATED_TIME TIMESTAMP(0) NULL,
            IDP_ID INTEGER DEFAULT -1 NOT NULL
);
...
CREATE TABLE IF NOT EXISTS IDN_OAUTH2_DEVICE_FLOW (
            ...
            CONSUMER_KEY_ID INTEGER,
            LAST_POLL_TIME TIMESTAMP(0) NOT NULL DEFAULT CURRENT_TIMESTAMP,
            EXPIRY_TIME TIMESTAMP(0) NOT NULL DEFAULT CURRENT_TIMESTAMP,
            TIME_CREATED TIMESTAMP(0) NOT NULL DEFAULT CURRENT_TIMESTAMP,
            POLL_TIME BIGINT,
...
-- SQLINES LICENSE FOR EVALUATION USE ONLY
CREATE SEQUENCE IDN_OAUTH2_DEVICE_FLOW_SCOPES_seq;

CREATE TABLE IF NOT EXISTS IDN_OAUTH2_DEVICE_FLOW_SCOPES (
            ID INTEGER NOT NULL DEFAULT NEXTVAL ('IDN_OAUTH2_DEVICE_FLOW_SCOPES_seq'),
...
-- SQLINES LICENSE FOR EVALUATION USE ONLY
CREATE SEQUENCE IDN_OAUTH2_SCOPE_seq;

CREATE TABLE IF NOT EXISTS IDN_OAUTH2_SCOPE (
            SCOPE_ID INTEGER NOT NULL DEFAULT NEXTVAL ('IDN_OAUTH2_SCOPE_seq'),
...
CREATE TABLE IF NOT EXISTS IDN_OPENID_ASSOCIATIONS (
            ...
            EXPIRE_IN TIMESTAMP(0) NOT NULL,
...
CREATE TABLE IF NOT EXISTS IDN_STS_STORE (
            ...
            EXPIRE_DATE TIMESTAMP(0) NOT NULL DEFAULT CURRENT_TIMESTAMP,
...
CREATE TABLE IF NOT EXISTS SP_APP (
        ID INTEGER NOT NULL DEFAULT NEXTVAL ('SP_APP_seq'),
        TENANT_ID INTEGER NOT NULL,
...
CREATE TABLE IF NOT EXISTS SP_INBOUND_AUTH (
            ID INTEGER NOT NULL DEFAULT NEXTVAL ('SP_INBOUND_AUTH_seq'),
            TENANT_ID INTEGER NOT NULL,
...
CREATE TABLE IF NOT EXISTS SP_AUTH_STEP (
            ID INTEGER NOT NULL DEFAULT NEXTVAL ('SP_AUTH_STEP_seq'),
            TENANT_ID INTEGER NOT NULL,
...
CREATE TABLE IF NOT EXISTS SP_CLAIM_DIALECT (
	   	ID INTEGER NOT NULL DEFAULT NEXTVAL ('SP_CLAIM_DIALECT_seq'),
	   	TENANT_ID INTEGER NOT NULL,
...
CREATE TABLE IF NOT EXISTS SP_CLAIM_MAPPING (
            ID INTEGER NOT NULL DEFAULT NEXTVAL ('SP_CLAIM_MAPPING_seq'),
            TENANT_ID INTEGER NOT NULL,
...
CREATE TABLE IF NOT EXISTS SP_ROLE_MAPPING (
            ID INTEGER NOT NULL DEFAULT NEXTVAL ('SP_ROLE_MAPPING_seq'),
            TENANT_ID INTEGER NOT NULL,
...
-- SQLINES LICENSE FOR EVALUATION USE ONLY
CREATE SEQUENCE SP_REQ_PATH_AUTHENTICATOR_seq;

CREATE TABLE IF NOT EXISTS SP_REQ_PATH_AUTHENTICATOR (
            ID INTEGER NOT NULL DEFAULT NEXTVAL ('SP_REQ_PATH_AUTHENTICATOR_seq'),
            TENANT_ID INTEGER NOT NULL,
...
-- SQLINES LICENSE FOR EVALUATION USE ONLY
CREATE SEQUENCE SP_PROVISIONING_CONNECTOR_seq;

CREATE TABLE IF NOT EXISTS SP_PROVISIONING_CONNECTOR (
            ID INTEGER NOT NULL DEFAULT NEXTVAL ('SP_PROVISIONING_CONNECTOR_seq'),
            TENANT_ID INTEGER NOT NULL,
...
CREATE TABLE SP_AUTH_SCRIPT (
  ID         INTEGER DEFAULT NEXTVAL ('SP_AUTH_SCRIPT_seq') NOT NULL,
  TENANT_ID  INTEGER                NOT NULL,
  APP_ID     INTEGER                NOT NULL,
...
CREATE TABLE IF NOT EXISTS SP_TEMPLATE (
  ID         INTEGER DEFAULT NEXTVAL ('SP_TEMPLATE_seq') NOT NULL,
  TENANT_ID  INTEGER                NOT NULL,
  NAME VARCHAR(255) NOT NULL,
...
CREATE TABLE IF NOT EXISTS IDN_AUTH_WAIT_STATUS (
  ID              INTEGER DEFAULT NEXTVAL ('IDN_AUTH_WAIT_STATUS_seq') NOT NULL,
  TENANT_ID       INTEGER                NOT NULL,
...
-- SQLINES LICENSE FOR EVALUATION USE ONLY
CREATE SEQUENCE IDP_AUTHENTICATOR_PROPERTY_seq;

CREATE TABLE IF NOT EXISTS IDP_AUTHENTICATOR_PROPERTY (
            ID INTEGER DEFAULT NEXTVAL ('IDP_AUTHENTICATOR_PROPERTY_seq'),
            TENANT_ID INTEGER,
...
-- SQLINES LICENSE FOR EVALUATION USE ONLY
CREATE SEQUENCE IDP_PROVISIONING_CONFIG_seq;

CREATE TABLE IF NOT EXISTS IDP_PROVISIONING_CONFIG (
            ID INTEGER DEFAULT NEXTVAL ('IDP_PROVISIONING_CONFIG_seq'),
            TENANT_ID INTEGER,
            IDP_ID INTEGER,
...
-- SQLINES LICENSE FOR EVALUATION USE ONLY
CREATE SEQUENCE IDP_PROV_CONFIG_PROPERTY_seq;

CREATE TABLE IF NOT EXISTS IDP_PROV_CONFIG_PROPERTY (
            ID INTEGER DEFAULT NEXTVAL ('IDP_PROV_CONFIG_PROPERTY_seq'),
            TENANT_ID INTEGER,
...
-- SQLINES LICENSE FOR EVALUATION USE ONLY
CREATE SEQUENCE IDP_PROVISIONING_ENTITY_seq;

CREATE TABLE IF NOT EXISTS IDP_PROVISIONING_ENTITY (
            ID INTEGER DEFAULT NEXTVAL ('IDP_PROVISIONING_ENTITY_seq'),
            PROVISIONING_CONFIG_ID INTEGER,
...
-- SQLINES LICENSE FOR EVALUATION USE ONLY
CREATE SEQUENCE WF_WORKFLOW_ASSOCIATION_seq;

CREATE TABLE IF NOT EXISTS WF_WORKFLOW_ASSOCIATION(
    ID INTEGER NOT NULL DEFAULT NEXTVAL ('WF_WORKFLOW_ASSOCIATION_seq'),
...
-- SQLINES LICENSE FOR EVALUATION USE ONLY
CREATE SEQUENCE IDN_PASSWORD_HISTORY_DATA_seq;

CREATE TABLE IF NOT EXISTS IDN_PASSWORD_HISTORY_DATA (
  ID INTEGER NOT NULL DEFAULT NEXTVAL ('IDN_PASSWORD_HISTORY_DATA_seq'),
  USER_NAME   VARCHAR(255) NOT NULL,
  USER_DOMAIN VARCHAR(127) NOT NULL,
  TENANT_ID   INTEGER DEFAULT -1,
...
CREATE TABLE IF NOT EXISTS IDN_CLAIM_DIALECT (
  ID INTEGER NOT NULL DEFAULT NEXTVAL ('IDN_CLAIM_DIALECT_seq'),
...
CREATE TABLE IF NOT EXISTS IDN_CLAIM (
  ID INTEGER NOT NULL DEFAULT NEXTVAL ('IDN_CLAIM_seq'),
...
CREATE TABLE IF NOT EXISTS IDN_CLAIM_MAPPED_ATTRIBUTE (
  ID INTEGER NOT NULL DEFAULT NEXTVAL ('IDN_CLAIM_MAPPED_ATTRIBUTE_seq'),
...
CREATE TABLE IF NOT EXISTS IDN_CLAIM_PROPERTY (
  ID INTEGER NOT NULL DEFAULT NEXTVAL ('IDN_CLAIM_PROPERTY_seq'),
  LOCAL_CLAIM_ID INTEGER,
...
CREATE TABLE IF NOT EXISTS IDN_CLAIM_MAPPING (
  ID INTEGER NOT NULL DEFAULT NEXTVAL ('IDN_CLAIM_MAPPING_seq'),
...
CREATE TABLE IF NOT EXISTS  IDN_SAML2_ASSERTION_STORE (
  ID INTEGER NOT NULL DEFAULT NEXTVAL ('IDN_SAML2_ASSERTION_STORE_seq'),
...
CREATE TABLE IDN_SAML2_ARTIFACT_STORE (
  ID INT NOT NULL DEFAULT NEXTVAL ('IDN_SAML2_ARTIFACT_STORE_seq'),
  SOURCE_ID VARCHAR(255) NOT NULL,
  MESSAGE_HANDLER VARCHAR(255) NOT NULL,
  AUTHN_REQ_DTO BYTEA NOT NULL,
  SESSION_ID VARCHAR(255) NOT NULL,
  EXP_TIMESTAMP TIMESTAMP(0) NOT NULL,
  INIT_TIMESTAMP TIMESTAMP(0) NOT NULL DEFAULT CURRENT_TIMESTAMP,
...
CREATE TABLE IF NOT EXISTS  IDN_OIDC_PROPERTY (
  ID INTEGER NOT NULL DEFAULT NEXTVAL ('IDN_OIDC_PROPERTY_seq'),
  TENANT_ID  INTEGER,
  CONSUMER_KEY  VARCHAR(255) ,
  PROPERTY_KEY  VARCHAR(255) NOT NULL,
  PROPERTY_VALUE  VARCHAR(2047) ,
...
-- SQLINES LICENSE FOR EVALUATION USE ONLY
CREATE SEQUENCE IDN_OIDC_REQ_OBJECT_REFERENCE_seq;

CREATE TABLE IF NOT EXISTS IDN_OIDC_REQ_OBJECT_REFERENCE (
  ID INTEGER NOT NULL DEFAULT NEXTVAL ('IDN_OIDC_REQ_OBJECT_REFERENCE_seq'),
  CONSUMER_KEY_ID INTEGER ,
  CODE_ID VARCHAR(255) ,
  TOKEN_ID VARCHAR(255) ,
...
CREATE TABLE IF NOT EXISTS IDN_OIDC_REQ_OBJECT_CLAIMS (
  ID INTEGER NOT NULL DEFAULT NEXTVAL ('IDN_OIDC_REQ_OBJECT_CLAIMS_seq'),
...
-- SQLINES LICENSE FOR EVALUATION USE ONLY
CREATE SEQUENCE IDN_OIDC_REQ_OBJ_CLAIM_VALUES_seq;

CREATE TABLE IF NOT EXISTS IDN_OIDC_REQ_OBJ_CLAIM_VALUES (
  ID INTEGER NOT NULL DEFAULT NEXTVAL ('IDN_OIDC_REQ_OBJ_CLAIM_VALUES_seq'),
...
-- SQLINES LICENSE FOR EVALUATION USE ONLY
CREATE SEQUENCE IDN_CERTIFICATE_seq;

CREATE TABLE IF NOT EXISTS IDN_CERTIFICATE (
             ID INTEGER NOT NULL DEFAULT NEXTVAL ('IDN_CERTIFICATE_seq'),
             NAME VARCHAR(100),
...
-- SQLINES LICENSE FOR EVALUATION USE ONLY
CREATE SEQUENCE IDN_OIDC_SCOPE_CLAIM_MAPPING_seq;

CREATE TABLE IF NOT EXISTS IDN_OIDC_SCOPE_CLAIM_MAPPING (
            ID INTEGER NOT NULL DEFAULT NEXTVAL ('IDN_OIDC_SCOPE_CLAIM_MAPPING_seq'),
            SCOPE_ID INTEGER NOT NULL,
...
CREATE TABLE IF NOT EXISTS IDN_OAUTH2_CIBA_AUTH_CODE (
    ...
    AUTH_REQ_ID CHAR (36),
    ISSUED_TIME TIMESTAMP(0) NOT NULL DEFAULT CURRENT_TIMESTAMP,
    CONSUMER_KEY VARCHAR(255),
    LAST_POLLED_TIME TIMESTAMP(0) NOT NULL DEFAULT CURRENT_TIMESTAMP,
...
CREATE TABLE IF NOT EXISTS IDN_CONFIG_RESOURCE (
    ...
    HAS_FILE smallint NOT NULL,
    HAS_ATTRIBUTE smallint NOT NULL,
...
CREATE TABLE IDN_REMOTE_FETCH_REVISIONS (
	...
	DEPLOYED_DATE TIMESTAMP(0) NOT NULL DEFAULT CURRENT_TIMESTAMP,
	LAST_SYNC_TIME TIMESTAMP(0) NOT NULL DEFAULT CURRENT_TIMESTAMP,
...
-- SQLINES LICENSE FOR EVALUATION USE ONLY
CREATE SEQUENCE IDN_CORS_ORIGIN_seq;

CREATE TABLE IF NOT EXISTS IDN_CORS_ORIGIN (
    ID                INT           NOT NULL DEFAULT NEXTVAL ('IDN_CORS_ORIGIN_seq'),
    TENANT_ID         INT           NOT NULL,
...
-- SQLINES DEMO *** MGT Tables --

-- SQLINES LICENSE FOR EVALUATION USE ONLY
CREATE SEQUENCE CM_PII_CATEGORY_seq;

CREATE TABLE CM_PII_CATEGORY (
  ID           INTEGER DEFAULT NEXTVAL ('CM_PII_CATEGORY_seq'),
  NAME         VARCHAR(255) NOT NULL,
  DESCRIPTION  VARCHAR(1023),
  DISPLAY_NAME VARCHAR(255),
...
CREATE TABLE CM_RECEIPT (
  ...
  CONSENT_TIMESTAMP   TIMESTAMP(0)    NOT NULL,
...
CREATE TABLE CM_PURPOSE (
  ID            INTEGER DEFAULT NEXTVAL ('CM_PURPOSE_seq'),
  NAME          VARCHAR(255) NOT NULL,
  DESCRIPTION   VARCHAR(1023),
...
CREATE TABLE CM_PURPOSE_CATEGORY (
  ID          INTEGER DEFAULT NEXTVAL ('CM_PURPOSE_CATEGORY_seq'),
  NAME        VARCHAR(255) NOT NULL,
  DESCRIPTION VARCHAR(1023),
  TENANT_ID   INTEGER DEFAULT '-1234',
  UNIQUE (NAME, TENANT_ID),
...
CREATE TABLE CM_RECEIPT_SP_ASSOC (
  ID                 INTEGER DEFAULT NEXTVAL ('CM_RECEIPT_SP_ASSOC_seq'),
  CONSENT_RECEIPT_ID VARCHAR(255) NOT NULL,
...
CREATE TABLE CM_SP_PURPOSE_ASSOC (
  ID                     INTEGER DEFAULT NEXTVAL ('CM_SP_PURPOSE_ASSOC_seq'),
...
-- SQLINES DEMO *** T Tables --

-- SQLINES DEMO *** Tables --
-- SQLINES LICENSE FOR EVALUATION USE ONLY
CREATE SEQUENCE AM_SUBSCRIBER_seq;

CREATE TABLE IF NOT EXISTS AM_SUBSCRIBER (
    SUBSCRIBER_ID INTEGER DEFAULT NEXTVAL ('AM_SUBSCRIBER_seq'),
    USER_ID VARCHAR(255) NOT NULL,
    TENANT_ID INTEGER NOT NULL,
    EMAIL_ADDRESS VARCHAR(256) NULL,
    DATE_SUBSCRIBED TIMESTAMP(0) NOT NULL,
...
-- SQLINES LICENSE FOR EVALUATION USE ONLY
CREATE SEQUENCE AM_APPLICATION_seq;

CREATE TABLE IF NOT EXISTS AM_APPLICATION (
    APPLICATION_ID INTEGER DEFAULT NEXTVAL ('AM_APPLICATION_seq'),
    NAME VARCHAR(100),
...
-- SQLINES LICENSE FOR EVALUATION USE ONLY
CREATE SEQUENCE AM_API_seq;

CREATE TABLE IF NOT EXISTS AM_API (
    API_ID INTEGER DEFAULT NEXTVAL ('AM_API_seq'),
...
-- SQLINES LICENSE FOR EVALUATION USE ONLY
CREATE SEQUENCE AM_API_URL_MAPPING_seq;

CREATE TABLE IF NOT EXISTS AM_API_URL_MAPPING (
    URL_MAPPING_ID INTEGER DEFAULT NEXTVAL ('AM_API_URL_MAPPING_seq'),
    API_ID INTEGER NOT NULL,
...
-- SQLINES LICENSE FOR EVALUATION USE ONLY
CREATE SEQUENCE AM_API_PRODUCT_MAPPING_seq;

CREATE TABLE IF NOT EXISTS AM_API_PRODUCT_MAPPING (
	API_PRODUCT_MAPPING_ID INTEGER DEFAULT NEXTVAL ('AM_API_PRODUCT_MAPPING_seq'),
	API_ID INTEGER,
...
-- SQLINES LICENSE FOR EVALUATION USE ONLY
CREATE SEQUENCE AM_SUBSCRIPTION_seq;

CREATE TABLE IF NOT EXISTS AM_SUBSCRIPTION (
    SUBSCRIPTION_ID INTEGER DEFAULT NEXTVAL ('AM_SUBSCRIPTION_seq'),
    TIER_ID VARCHAR(50),
    TIER_ID_PENDING VARCHAR(50),
    API_ID INTEGER,
    LAST_ACCESSED TIMESTAMP(0) NULL,
...
-- SQLINES LICENSE FOR EVALUATION USE ONLY
CREATE SEQUENCE AM_API_LC_EVENT_seq;

CREATE TABLE IF NOT EXISTS AM_API_LC_EVENT (
    EVENT_ID INTEGER DEFAULT NEXTVAL ('AM_API_LC_EVENT_seq'),
    API_ID INTEGER NOT NULL,
...
-- SQLINES LICENSE FOR EVALUATION USE ONLY
CREATE SEQUENCE AM_TIER_PERMISSIONS_seq;

CREATE TABLE IF NOT EXISTS AM_TIER_PERMISSIONS (
    TIER_PERMISSIONS_ID INTEGER DEFAULT NEXTVAL ('AM_TIER_PERMISSIONS_seq'),
...
-- SQLINES LICENSE FOR EVALUATION USE ONLY
CREATE SEQUENCE AM_EXTERNAL_STORES_seq;

CREATE TABLE IF NOT EXISTS AM_EXTERNAL_STORES (
    APISTORE_ID INTEGER DEFAULT NEXTVAL ('AM_EXTERNAL_STORES_seq'),
    API_ID INTEGER,
    STORE_ID VARCHAR(255) NOT NULL,
    STORE_DISPLAY_NAME VARCHAR(255) NOT NULL,
    STORE_ENDPOINT VARCHAR(255) NOT NULL,
    STORE_TYPE VARCHAR(255) NOT NULL,
    LAST_UPDATED_TIME TIMESTAMP(0) DEFAULT CURRENT_TIMESTAMP,
FOREIGN KEY(API_ID) REFERENCES AM_API(API_ID) ON UPDATE CASCADE ON DELETE RESTRICT,
...
CREATE TABLE IF NOT EXISTS AM_WORKFLOWS(
    WF_ID INTEGER DEFAULT NEXTVAL ('AM_WORKFLOWS_seq'),
    WF_REFERENCE VARCHAR(255) NOT NULL,
    WF_TYPE VARCHAR(255) NOT NULL,
    WF_STATUS VARCHAR(255) NOT NULL,
    WF_CREATED_TIME TIMESTAMP(0),
    WF_UPDATED_TIME TIMESTAMP(0) DEFAULT CURRENT_TIMESTAMP ,
...
-- SQLINES LICENSE FOR EVALUATION USE ONLY
CREATE SEQUENCE AM_APPLICATION_REGISTRATION_seq;

CREATE TABLE IF NOT EXISTS AM_APPLICATION_REGISTRATION (
    REG_ID INT DEFAULT NEXTVAL ('AM_APPLICATION_REGISTRATION_seq'),
    SUBSCRIBER_ID INT,
...
-- SQLINES LICENSE FOR EVALUATION USE ONLY
CREATE SEQUENCE AM_API_DEFAULT_VERSION_seq;

CREATE TABLE IF NOT EXISTS AM_API_DEFAULT_VERSION (
    DEFAULT_VERSION_ID INT DEFAULT NEXTVAL ('AM_API_DEFAULT_VERSION_seq'),
...
-- SQLINES LICENSE FOR EVALUATION USE ONLY
CREATE SEQUENCE AM_ALERT_TYPES_seq;
...
-- SQLINES LICENSE FOR EVALUATION USE ONLY
CREATE SEQUENCE AM_ALERT_EMAILLIST_seq;
...
-- SQLINES LICENSE FOR EVALUATION USE ONLY
CREATE SEQUENCE AM_POLICY_SUBSCRIPTION_seq;

CREATE TABLE IF NOT EXISTS AM_POLICY_SUBSCRIPTION (
            POLICY_ID INT NOT NULL DEFAULT NEXTVAL ('AM_POLICY_SUBSCRIPTION_seq'),
...
-- SQLINES LICENSE FOR EVALUATION USE ONLY
CREATE SEQUENCE AM_POLICY_APPLICATION_seq;

CREATE TABLE IF NOT EXISTS AM_POLICY_APPLICATION (
            POLICY_ID INT NOT NULL DEFAULT NEXTVAL ('AM_POLICY_APPLICATION_seq'),
            NAME VARCHAR(512) NOT NULL,
            DISPLAY_NAME VARCHAR(512) NULL DEFAULT NULL,
            TENANT_ID INT NOT NULL,
            DESCRIPTION VARCHAR(1024) NULL DEFAULT NULL,
...
-- SQLINES LICENSE FOR EVALUATION USE ONLY
CREATE SEQUENCE AM_POLICY_HARD_THROTTLING_seq;

CREATE TABLE IF NOT EXISTS AM_POLICY_HARD_THROTTLING (
            POLICY_ID INT NOT NULL DEFAULT NEXTVAL ('AM_POLICY_HARD_THROTTLING_seq'),
            NAME VARCHAR(512) NOT NULL,
            TENANT_ID INT NOT NULL,
            DESCRIPTION VARCHAR(1024) NULL DEFAULT NULL,
            QUOTA_TYPE VARCHAR(25) NOT NULL,
...
-- SQLINES LICENSE FOR EVALUATION USE ONLY
CREATE SEQUENCE AM_API_THROTTLE_POLICY_seq;

CREATE TABLE IF NOT EXISTS AM_API_THROTTLE_POLICY (
            POLICY_ID INT NOT NULL DEFAULT NEXTVAL ('AM_API_THROTTLE_POLICY_seq'),
            NAME VARCHAR(512) NOT NULL,
            DISPLAY_NAME VARCHAR(512) NULL DEFAULT NULL,
            TENANT_ID INT NOT NULL,
            DESCRIPTION VARCHAR (1024),
...
CREATE TABLE IF NOT EXISTS AM_CONDITION_GROUP (
            CONDITION_GROUP_ID INTEGER NOT NULL DEFAULT NEXTVAL ('AM_CONDITION_GROUP_seq'),
...
-- SQLINES LICENSE FOR EVALUATION USE ONLY
CREATE SEQUENCE AM_POLICY_GLOBAL_seq;

CREATE TABLE IF NOT EXISTS AM_POLICY_GLOBAL (
            POLICY_ID INT NOT NULL DEFAULT NEXTVAL ('AM_POLICY_GLOBAL_seq'),
            NAME VARCHAR(512) NOT NULL,
...
-- SQLINES LICENSE FOR EVALUATION USE ONLY
CREATE SEQUENCE AM_THROTTLE_TIER_PERMISSIONS_seq;

CREATE TABLE IF NOT EXISTS AM_THROTTLE_TIER_PERMISSIONS (
  THROTTLE_TIER_PERMISSIONS_ID INT NOT NULL DEFAULT NEXTVAL ('AM_THROTTLE_TIER_PERMISSIONS_seq'),
...
-- SQLINES LICENSE FOR EVALUATION USE ONLY
CREATE SEQUENCE AM_BLOCK_CONDITIONS_seq;

CREATE TABLE AM_BLOCK_CONDITIONS (
  CONDITION_ID int NOT NULL DEFAULT NEXTVAL ('AM_BLOCK_CONDITIONS_seq'),
...
CREATE TABLE IF NOT EXISTS AM_USAGE_UPLOADED_FILES (
  ...
  FILE_PROCESSED smallint DEFAULT FALSE,
  FILE_CONTENT MEDIUMBLOB DEFAULT NULL,
  PRIMARY KEY (TENANT_DOMAIN, FILE_NAME, FILE_TIMESTAMP)
) ;

-- SQLINES LICENSE FOR EVALUATION USE ONLY
CREATE SEQUENCE AM_API_LC_PUBLISH_EVENTS_seq;

CREATE TABLE IF NOT EXISTS AM_API_LC_PUBLISH_EVENTS (
    ID INTEGER NOT NULL DEFAULT NEXTVAL ('AM_API_LC_PUBLISH_EVENTS_seq'),
...
CREATE TABLE IF NOT EXISTS AM_REVOKED_JWT (
    ...
    TIME_CREATED TIMESTAMP(0) DEFAULT CURRENT_TIMESTAMP,
    PRIMARY KEY (UUID)
) ;
...
-- SQLINES DEMO *** PI_DETAILS & AM_GW_API_ARTIFACTS are independent tables for Artifact synchronizer feature which --
-- SQLINES DEMO *** ny referential integrity constraints with other tables in AM database--
-- SQLINES LICENSE FOR EVALUATION USE ONLY
...
-- SQLINES LICENSE FOR EVALUATION USE ONLY
CREATE SEQUENCE AM_SCOPE_seq;

CREATE TABLE IF NOT EXISTS AM_SCOPE (
            SCOPE_ID INTEGER NOT NULL DEFAULT NEXTVAL ('AM_SCOPE_seq'),
            NAME VARCHAR(255) NOT NULL,
            DISPLAY_NAME VARCHAR(255) NOT NULL,
            DESCRIPTION VARCHAR(512),
            TENANT_ID INTEGER NOT NULL DEFAULT -1,
...
CREATE TABLE IF NOT EXISTS AM_DEPLOYMENT_REVISION_MAPPING (
  ...
  DEPLOYED_TIME TIMESTAMP(0) DEFAULT CURRENT_TIMESTAMP,
...
-- SQLINES DEMO *** nts Table --
-- SQLINES LICENSE FOR EVALUATION USE ONLY
CREATE SEQUENCE AM_GATEWAY_ENVIRONMENT_seq;

CREATE TABLE IF NOT EXISTS AM_GATEWAY_ENVIRONMENT (
  ID INTEGER NOT NULL DEFAULT NEXTVAL ('AM_GATEWAY_ENVIRONMENT_seq'),
...
CREATE TABLE IF NOT EXISTS AM_SERVICE_CATALOG (
            ...
            LAST_UPDATED_TIME TIMESTAMP(0) NULL,
            CREATED_BY VARCHAR(255),
...
-- Webhooks --
-- SQLINES LICENSE FOR EVALUATION USE ONLY
CREATE SEQUENCE AM_WEBHOOKS_SUBSCRIPTION_seq;

CREATE TABLE IF NOT EXISTS AM_WEBHOOKS_SUBSCRIPTION (
            WH_SUBSCRIPTION_ID INTEGER NOT NULL DEFAULT NEXTVAL ('AM_WEBHOOKS_SUBSCRIPTION_seq'),
